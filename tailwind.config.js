...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // All colors are driven by CSS variables (see src/styles/tokens.css)
        // so dark mode and brand theming stay in one place.
      ...
      boxShadow: {
        ...
        sheet: "0 -8px 40px -12px rgba(0,0,0,0.25)",
        fab: "0 8px 24px -8px hsl(var(--primary) / 0.5)",
      },
      spacing: {
